...
email:
  ...
  smtp_port: 25
  smtp_user: "pangolin"
  # smtp_pass is read from EMAIL_SMTP_PASS environment variable
  smtp_secure: false
...
- [Post-Deployment Setup](./post-deployment) — Complete Pangolin dashboard configuration
- [Configure SSO](/docs/post-deployment/configure-sso) — Set up identity provider integration
- [Expose Services](/docs/post-deployment/expose-services) — Add resources in Pangolin
