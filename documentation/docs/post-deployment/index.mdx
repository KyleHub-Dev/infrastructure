---
title: Post-Deployment Overview
sidebar_position: 1
description: Configuration tasks after deploying both stacks
---

# Post-Deployment Configuration

After deploying both the Gateway VPS and Homelab Core stacks, complete these configuration steps to fully enable the platform.
...
```mermaid
flowchart TD
    A[VPS Deployed] --> B[Homelab Deployed]
    B --> C[NEWT Connected]
    C --> D[Configure Zitadel]
    D --> E[Add Identity Provider to Pangolin]
    E --> F[Expose First Service]
    F --> G[Configure SSO]
    G --> H[Add More Services]
```
