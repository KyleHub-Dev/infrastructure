...
1. **[Expose Services](/docs/service-configuration/expose-services)** — Add resources in Pangolin
2. **[Configure SSO](/docs/service-configuration/configure-sso)** — Protect services with Zitadel
