...
2. Configure:
   ...
   - **Type**: Web
   - **Authentication Method**: PKCE (Recommended for better security)
...
Create roles for different access levels. You can use uppercase names if your custom implementation requires them:
