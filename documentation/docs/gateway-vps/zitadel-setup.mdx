...
Zitadel is the identity provider for all KyleHub services. This guide covers initial configuration and integration with Pangolin.
...
Store the Client ID and Client Secret securely. You'll need them for Pangolin configuration.
:::
